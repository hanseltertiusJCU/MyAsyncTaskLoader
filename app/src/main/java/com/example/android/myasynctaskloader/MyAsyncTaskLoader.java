package com.example.android.myasynctaskloader;
...
public class MyAsyncTaskLoader extends AsyncTaskLoader<ArrayList<WeatherItems>> {
    ...
    private static final String API_KEY = "11b6fbc8158286e158ba136028ae83dd";
    ...
    public ArrayList<WeatherItems> loadInBackground() {
        ...
        client.get(url, new AsyncHttpResponseHandler() {
            ...
            public void onFailure(int statusCode, Header[] headers, byte[] responseBody, Throwable error) {
                // Jika responsenya gagal, maka method tersebut akan di call dan do nothing
            }
        });
